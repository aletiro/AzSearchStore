...
export class AzSearchStore {
    ...
    public addCheckboxFacet(fieldName: string, dataType: Store.CheckboxDataType, count: number, sort: Store.FacetSortingMode, values: {}) {
        this.store.dispatch(facetsActions.addCheckboxFacet(fieldName, dataType, count, sort, values));
    }
